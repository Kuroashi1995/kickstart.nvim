...
--    See `:help lazy.nvim.txt` or htts://github.com/folke/lazy.nvim for more info
...
require('lazy').setup({
  ...
  --
  -- Use `opts = {}` to force a plugin to be loaded. Here is a more advanced example where we pass configuration options to `gitsigns.nvim`. This is equivalent to the following Lua: require('gitsigns').setup({ ... })
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      --        For example, to see the options for `lua_ls`, you could go to: https://luals.gmithub.io/wiki/settings/
      local servers = {
        clangd = {},
        gopls = {
          -- cmd = { 'gopls' },
